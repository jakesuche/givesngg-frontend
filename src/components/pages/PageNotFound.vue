...
<script>
import { pageNotFound } from "@/animate";
export default {
  mounted() {
    pageNotFound(this.$refs.row, this.$refs.svg, this.$refs.zero);
  },
  methods:{
    goBack(){
      this.$router.go(-1)
...
button{
  background:rgb(47,24,41)!important
}
</style>
