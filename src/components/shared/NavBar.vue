...
<div>
  <nav class="navbar fixed navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
       <button @click.prevent="active=!active" class="navbar-toggler" type="button"  >
   ...
   <div id="parentx">
    ...
    <vs-sidebar parent="body" default-index="1"  color="primary" class="sidebarx" spacer v-model="active">
      ...
      <ul class="list-group">
         <li class="list-group-item" @click="$router.push({ path: '/register' })"> Sign up </li>
        <li class="list-group-item" @click="$router.push({ path: '/login' })"> Login </li>
      ...
      <div class="footer-sidebar" slot="footer">
        <vs-button icon="reply" color="danger" type="flat" @click="$router.push('/')" >log out</vs-button>
